...
var _updateSettingDefault = parcelHelpers.interopDefault(_updateSetting);
...
logoutForm?.addEventListener("click", (0, _logoutDefault.default));
updateUserForm?.addEventListener("submit", function(e) {
    e.preventDefault();
    const userUpdated = new FormData(this);
    console.log(userUpdated);
    (0, _updateSettingDefault.default)(userUpdated, "user");
});
updatePasswordForm?.addEventListener("submit", async function(e) {
    ...
    await (0, _updateSettingDefault.default)(newPass, "password");
...
payBtn?.addEventListener("click", async function() {
    ...
    await (0, _stripeDefault.default)(this.dataset.tourId);
    this.textContent = "Book tour now!";
});

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","core-js/modules/web.immediate.js":"49tUX","regenerator-runtime/runtime":"dXNgZ","./login":"7yHem","./logout":"1ftRF","./updateSetting":"6GcZk","./stripe":"10tSC"}],"gkKU3":[function(require,module,exports) {
...
const showPopUp = function(type, message) {
    hidePopUp();
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/* eslint-disable */ exports.default = async function() {
    try {
        const res = await axios({
            url: "http://localhost:3000/api/v1/users/logout",
            method: "GET"
...
exports.default = async function(data, type) {
    try {
        ...
        type === "password" ? (0, _loginJs.showPopUp)("success", "Password updated") : (0, _loginJs.showPopUp)("success", "Data updated");
    } catch (err) {
        console.error(err);
        (0, _loginJs.showPopUp)("error", err.response.data.message);
    }
};

},{"./login.js":"7yHem","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"10tSC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _login = require("./login");
const stripe = Stripe("pk_test_51LWN6VFI2ilgj0fiMOeStkzpJMGxdWbJKMBF9OZEC7JgCAbtP0yZ6dTWZO2tvyoEbz0hTAsUxOw8xtaGMuIoDUVL00eEhNfbED");
exports.default = async (tourId)=>{
    try {
        const res = await axios(`http://localhost:3000/api/v1/booking/create-season/${tourId}`);
        ...
        (0, _login.showPopUp)("error", "Payment failed");
        console.error(err);
    }
};

},{"./login":"7yHem","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["dhFGg","f2QDv"], "f2QDv", "parcelRequire11c7")
